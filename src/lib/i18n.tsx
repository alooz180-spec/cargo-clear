...
const en: Dict = {
  ...
  // Split combined PDF
  "split.button": "Split a combined PDF",
  "split.title": "Split a combined PDF into documents",
  "split.subtitle": "Assign each page to a document slot, then create separate PDFs. Pages you ignore are discarded.",
  "split.selectFile": "Select or drop a PDF",
  "split.dropHere": "Drop the PDF here",
  "split.onlyPdf": "Only PDF files can be split.",
  "split.oneFile": "Choose a single PDF to split.",
  "split.loading": "Loading PDF…",
  "split.loadFailed": "Could not read this PDF.",
  "split.page": "Page {n}",
  "split.assignTo": "Assign page to…",
  "split.ignore": "Ignore (discard)",
  "split.planTitle": "Plan",
  "split.pagesRange": "pages {range}",
  "split.pageSingle": "page {n}",
  "split.ignoredCount": "{n} page ignored",
  "split.ignoredCountPlural": "{n} pages ignored",
  "split.nothingAssigned": "No pages assigned yet — every page is set to ignore.",
  "split.create": "Create documents",
  "split.creating": "Creating…",
  "split.replaceTitle": "Replace existing file?",
  "split.replaceBody": "{n} document slot(s) already have a file: {slots}. Replace them with the new split pages? Existing files will be overwritten.",
  "split.replaceConfirm": "Replace and create",
  "split.replaceCancel": "Cancel",
  "split.progress": "Creating {done} of {total}…",
  "split.complete": "Split complete — {n} document(s) created.",
  "split.partial": "Created {done} document(s); {failed} failed: {slots}.",
  "split.failed": "Split failed. No documents were created.",
  "split.changeFile": "Choose a different PDF",
  "split.currentDocs": "Current documents",
  "split.newCopiesGroup": "New copies",
  "split.addCopyGroup": "Add a new copy",
  "split.newCopyOf": "＋ New copy of {doc}",
  "split.copyLabel": "{doc} — new copy {n}",
  "split.addCopyTarget": "Add another copy target",
  "split.addCopyTargetHint": "Create separate copy targets to split several shipments into their own files.",
  "split.addCopyTargetAria": "Add another copy target",
  "split.removeCopyTarget": "Remove copy target",
  "split.conflictTitle": "Some slots already have a file",
  "split.conflictBody": "Choose what to do for each document that already has a file. Nothing is overwritten unless you pick “Replace existing”.",
  "split.replaceExisting": "Replace existing",
  "split.addAsNewCopy": "Add as a new copy instead",
  "split.conflictConfirm": "Create documents",
  ...
  "toast.openFailed": "Could not open the file. Please try again.",
  "toast.downloadFailed": "Could not download the file. Please try again.",
...
const ar: Dict = {
  ...
  // Split combined PDF
  "split.button": "تقسيم ملف PDF مدمج",
  "split.title": "تقسيم ملف PDF مدمج إلى مستندات",
  "split.subtitle": "عيّن كل صفحة إلى خانة مستند ثم أنشئ ملفات PDF منفصلة. الصفحات التي تتجاهلها يتم تجاهلها.",
  "split.selectFile": "اختر أو أفلت ملف PDF",
  "split.dropHere": "أفلت ملف PDF هنا",
  "split.onlyPdf": "يمكن تقسيم ملفات PDF فقط.",
  "split.oneFile": "اختر ملف PDF واحدًا للتقسيم.",
  "split.loading": "جارٍ تحميل الملف…",
  "split.loadFailed": "تعذّرت قراءة هذا الملف.",
  "split.page": "صفحة {n}",
  "split.assignTo": "عيّن الصفحة إلى…",
  "split.ignore": "تجاهل (حذف)",
  "split.planTitle": "الخطة",
  "split.pagesRange": "الصفحات {range}",
  "split.pageSingle": "صفحة {n}",
  "split.ignoredCount": "تم تجاهل صفحة {n}",
  "split.ignoredCountPlural": "تم تجاهل {n} صفحات",
  "split.nothingAssigned": "لم يتم تعيين أي صفحة — كل الصفحات مضبوطة على التجاهل.",
  "split.create": "إنشاء المستندات",
  "split.creating": "جارٍ الإنشاء…",
  "split.replaceTitle": "استبدال الملف الموجود؟",
  "split.replaceBody": "توجد ملفات في {n} خانة مستند: {slots}. استبدالها بالصفحات الجديدة؟ سيتم استبدال الملفات الحالية.",
  "split.replaceConfirm": "استبدال وإنشاء",
  "split.replaceCancel": "إلغاء",
  "split.progress": "جارٍ إنشاء {done} من {total}…",
  "split.complete": "اكتمل التقسيم — تم إنشاء {n} مستند.",
  "split.partial": "تم إنشاء {done} مستند؛ فشل {failed}: {slots}.",
  "split.failed": "فشل التقسيم. لم يتم إنشاء أي مستند.",
  "split.changeFile": "اختر ملف PDF آخر",
  "split.currentDocs": "المستندات الحالية",
  "split.newCopiesGroup": "نسخ جديدة",
  "split.addCopyGroup": "إضافة نسخة جديدة",
  "split.newCopyOf": "＋ نسخة جديدة من {doc}",
  "split.copyLabel": "{doc} — نسخة جديدة {n}",
  "split.addCopyTarget": "إضافة هدف نسخة أخرى",
  "split.addCopyTargetHint": "أنشئ أهداف نسخ منفصلة لتقسيم عدة شحنات إلى ملفات خاصة بها.",
  "split.addCopyTargetAria": "إضافة هدف نسخة أخرى",
  "split.removeCopyTarget": "إزالة هدف النسخة",
  "split.conflictTitle": "بعض الخانات تحتوي على ملف بالفعل",
  "split.conflictBody": "اختر ما تريد فعله لكل مستند يحتوي على ملف بالفعل. لن يتم استبدال أي شيء إلا إذا اخترت «استبدال الحالي».",
  "split.replaceExisting": "استبدال الحالي",
  "split.addAsNewCopy": "إضافة كنسخة جديدة بدلاً من ذلك",
  "split.conflictConfirm": "إنشاء المستندات",
  ...
  "toast.openFailed": "تعذّر فتح الملف. يرجى المحاولة مرة أخرى.",
  "toast.downloadFailed": "تعذّر تنزيل الملف. يرجى المحاولة مرة أخرى.",
